...
class Scoreboard():
    ...
    def prep_high_score(self):
        ...
        self.high_score_image = self.font.render(high_score_str, True, self.text_color, self.si_settings.bg_color)
    ...
    def prep_level(self):
        self.level_image = self.font.render(str(self.stats.level), True, self.text_color, self.si_settings.bg_color)
